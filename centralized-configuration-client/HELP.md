...
* The original package name 'ConfigClient.centralized-configuration-client' is invalid and this project uses 'ConfigClient.centralizedconfigurationclient' instead.

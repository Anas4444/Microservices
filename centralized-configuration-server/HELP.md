...
* The original package name 'ConfigServer.centralized-configuration-server' is invalid and this project uses 'ConfigServer.centralizedconfigurationserver' instead.
